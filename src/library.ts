...
- art. 28: o caput diz que equipamentos de radiação ionizante E NÃO IONIZANTE dependem de autorização do órgão sanitário e devem ser cadastrados. NÃO usar esse artigo para cobrar cadastro de laser terapêutico ou de fotobiomodulação: os incisos amarram o artigo ao radiodiagnóstico — II manda obedecer às normas da CNEN e III exige envoltórios radioprotetores para as partes do corpo fora do interesse diagnóstico, nada disso cumprível com laser de baixa potência. Decisão da Ester em 01/09/2026, ao revisar o suplemento de Parauapebas. A regularização do equipamento continua vindo da RDC Anvisa nº 751/2022.
